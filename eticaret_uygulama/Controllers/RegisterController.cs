        ...
        public async Task<IActionResult> Index(AppUserRegisterDto appUserRegisterDto)
        {
            ...
            AppUser appuser = new AppUser()
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    MailboxAddress mailboxAdressFrom = new MailboxAddress("Eticaret Uygulaması", "arikandogukan@gmail.com");
                    ...
                    client.Authenticate("arikandogukan@gmail.com", "zsqk tagc rhvh fknc");
